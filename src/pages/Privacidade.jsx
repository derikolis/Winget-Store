...
function Privacidade() {
  useEffect(() => {
    document.title = "Privacidade | Winget Store";
  }, []);
      ...
      <main className="max-w-3xl mx-auto px-8 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400">
            Transparência total sobre como o Winget Store trata seus dados —
            spoiler: não trata nenhum.
          </p>
        </div>
        ...
        <div className="bg-blue-600/10 border border-blue-600/30 rounded-xl p-5 mb-8 flex items-center gap-4">
          ...
          <p className="text-blue-300 text-sm leading-relaxed">
            O Winget Store{" "}
            <strong>não coleta, não armazena e não transmite</strong> nenhum
            dado pessoal. Tudo funciona 100% localmente no seu navegador.
          </p>
        </div>
