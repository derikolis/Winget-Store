...
import { HiCommandLine, HiArrowRight, HiShieldCheck } from "react-icons/hi2";
...
const requisitos = [
  {
    ...
    label: "Windows 10 (build 1809+) ou Windows 11",
  },
  {
    icon: <HiCommandLine size={16} />,
    label: "winget instalado (nativo no Windows 11)",
  },
  {
    icon: <HiShieldCheck size={16} />,
    label: "Recomendado: executar como Administrador",
  },
];

function ComoUsar() {
  useEffect(() => {
    document.title = "Como usar | Winget Store";
  }, []);
